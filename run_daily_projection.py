...
BUILDERS = {
    ...
    "ncaab": build_ncaab_report,
    "ncaaf": build_ncaaf_report,
}


def load_config():
    if not CONFIG_PATH.exists():
        return {"active_sports": ["nba", "mlb", "wnba", "nfl", "ufc", "leagues_cup", "tennis_atp", "tennis_wta", "nhl", "ncaab", "ncaaf"], "output_report": str(REPORT_OUT)}
